    ...
    'e-input':[
        {"title":"PROPS(配置数据)",
            value:[
                ...
                {"name":"options","default":"undefined","type":"Array","desc":"配置可参考list的lists选项"},
                ...
                {"name":"autocomplete","default":"undefined","type":"String","desc":"指定菜应该在外部激活器被点击时关闭。"},
                {"name":"multiple","default":"button","type":"String","desc":"指定为多选"},
                {"name":"inputValue","default":"true","type":"Any","desc":"v-model绑定数据"},
                {"name":"filter","default":"undefined","type":"function","desc":"筛选过滤规则"},
                {"name":"transition","default":"undefined","type":"String","desc":"过度效果"},
                {"name":"anchor","default":"undefined","type":"Any","desc":"弹出层挂载/显示的锚点位置"},
